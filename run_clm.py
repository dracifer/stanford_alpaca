...
class ModelArguments:
    ...
    max_position_embeddings_scale_factor: float = field(
        default=1.,
        metadata={
            "help": "Scale context window (default 2048) by this factor"
        },
    )
...
def main():
    ...
    if model_args.tokenizer_name:
        ...
        if model_args.model_name_or_path == "EleutherAI/gpt-neox-20b":
            ...
            print(f"BWEN: tokenizer: {type(tokenizer)}")
    ...
    if data_args.block_size is None:
        ...
        logger.info("Setting `block_size` to %d from cli input", data_args.block_size)
